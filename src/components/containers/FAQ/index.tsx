...
const FAQ = () => {
  ...
  return (
    <section className="faq">
      <h2 className="faq__h2 h2">Issuing and receiving a card</h2>
      <div className="faq__accordion">
        <Accordion activeItem={activeItem} setActiveItem={setActiveItem} items={questionsReceiving} />
      </div>
      <h2 className="faq__h2 h2">Using a credit card</h2>
      <div className="faq__accordion">
        <Accordion activeItem={activeItem} setActiveItem={setActiveItem} items={questionsUsing} />
      </div>
    </section>
  );
};
